	...
	public class AuthenticationController : ControllerBase
	{
		...
		public async Task<IActionResult> OAuth2(string code)
		{
			...
			using (var client = _httpClientFactory.CreateClient())
			{
				...
				new KeyValuePair<string, string>("redirect_uri", "https://poeprofittracker.com/authentication/redirect"),
				new KeyValuePair<string, string>("scope", "account:stashes account:profile account:characters")
				});
